...
const FloatingParticle = ({ size, color, delay, duration, xRange, yRange }) => {
          ...
          <div className="container px-4 md:px-6 relative">
            ...
            >
              <div className="space-y-2">
                ...
                >
                  Mozena builds smart, scalable software solutions for modern businesses.
                </motion.p>
              </div>
              <motion.div
                className="space-x-4"
          ...
          <div className="container px-4 md:px-6 relative">
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3 lg:gap-12">
              <AnimatedServiceCard
                ...
                title="IoT Solutions"
                description="Connect your devices and gather valuable data with our custom IoT solutions."
                delay={0}
              />
              <AnimatedServiceCard
                icon={<Database className="h-10 w-10 text-primary" />}
                title="ERP & CRM Development"
                description="Streamline your business operations with tailored ERP and CRM systems."
                delay={0.2}
              />
              <AnimatedServiceCard
              ...
              <AnimatedServiceCard
                ...
                description="Develop bespoke software solutions designed specifically for your unique requirements."
                delay={0.8}
              />
            </div>
          </div>
          ...
          <div className="container px-4 md:px-6 relative">
            ...
            >
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Explore some of our recent work and successful implementations.
                </p>
              </div>
            </motion.div>
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 md:grid-cols-2 lg:gap-12">
              <AnimatedProjectCard
                ...
                description="A comprehensive IoT solution for residential smart home automation and energy management."
                tags={["IoT", "Mobile App"]}
                delay={0}
              />
              <AnimatedProjectCard
                ...
                description="Custom ERP system for a manufacturing company to streamline operations and improve efficiency."
                tags={["ERP", "Web App"]}
                delay={0.2}
              />
              <AnimatedProjectCard
                ...
                description="An immersive mobile game with rich graphics and engaging storyline for iOS and Android."
                tags={["Game", "Mobile"]}
                delay={0.4}
              />
              <AnimatedProjectCard
                ...
                description="Comprehensive software solution for healthcare providers to manage patient data and operations."
        ...
        <section id="contact" className="w-full py-12 md:py-24 lg:py-32 relative overflow-hidden">
          ...
          <div className="container px-4 md:px-6 relative">
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-2">
              ...
              >
                <div className="space-y-2">
                  <h3 className="text-xl font-bold">Mozena Software</h3>
                  <p className="text-gray-500">
                    We're here to help you transform your business with innovative software solutions.
                  </p>
                </div>
      ...
      <footer className="w-full border-t py-6 md:py-0 relative overflow-hidden">
        ...
        <div className="container flex flex-col items-center justify-between gap-4 md:h-24 md:flex-row relative">
          <div className="flex items-center gap-2">
            ...
            <p className="text-sm text-gray-500">© {new Date().getFullYear()} Mozena. All rights reserved.</p>
          </div>
...
function AnimatedProjectCard({ image, title, description, tags, delay = 0 }) {
  const isMobile = useMobile()
